  ...
  try:
    ...
    if choice > 0 and choice < 5:
      ...
      if choice == 1 or choice == 3: 
        ...
        if choice ==   1: pyfoam.update(foldername, filename)
        elif choice == 3: pyfoam.delete(foldername, filename)
      elif choice == 2 or choice == 4:
        if choice ==   2: pyfoam.update(foldername)
        elif choice == 4: pyfoam.delete(foldername)
